...
public class OrderGUI extends JFrame {
    private JTextField addClientIDText;
    private JTextField addProductIDText;
    private JTextField addQuantityText;
    private JTextField addIDText;
    private JTextField editClientIDText;
    private JTextField editProductIDText;
    ...
    public OrderGUI() {
        ...
        JLabel firstnE = new JLabel("Client ID:");
        ...
        addClientIDText = new JTextField();
        addClientIDText.setBounds(131, 98, 121, 23);
        panelAdd.add(addClientIDText);
        addClientIDText.setColumns(10);

        JLabel lastNe = new JLabel("Product ID:");
        ...
        addProductIDText = new JTextField();
        addProductIDText.setColumns(10);
        addProductIDText.setBounds(131, 131, 121, 23);
        panelAdd.add(addProductIDText);
        ...
        JLabel fn = new JLabel("Client ID:");
        fn.setForeground(new Color(0, 100, 0));
        fn.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 20));
        fn.setBounds(10, 76, 121, 61);
        panelEdit.add(fn);

        editClientIDText = new JTextField();
        editClientIDText.setColumns(10);
        editClientIDText.setBounds(131, 98, 121, 23);
        panelEdit.add(editClientIDText);

        JLabel ln = new JLabel("Product ID:");
        ln.setForeground(new Color(0, 100, 0));
        ln.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 20));
        ln.setBounds(10, 107, 121, 61);
        panelEdit.add(ln);

        editProductIDText = new JTextField();
        editProductIDText.setColumns(10);
        editProductIDText.setBounds(131, 131, 121, 23);
        panelEdit.add(editProductIDText);
        ...
        ordersB.setForeground(new Color(0, 100, 0));
        ordersB.setFont(new Font("Tahoma", Font.BOLD, 15));
        ordersB.setBounds(661, 311, 144, 27);
        panel.add(ordersB);
    }
    ...
    public JButton getOrdersB() {
        return ordersB;
    }

    public int getAddClientIDText() {
        return Integer.parseInt(addClientIDText.getText());
    }
    ...
    public int getAddProductIDText() {
        return Integer.parseInt(addProductIDText.getText());
    }
    ...
    public String getEditClientIDText() {
        return editClientIDText.getText();
    }
    ...
    public String getEditProductIDText() {
        return editProductIDText.getText();
    }
}
